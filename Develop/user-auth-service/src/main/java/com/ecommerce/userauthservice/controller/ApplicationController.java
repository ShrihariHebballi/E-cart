...
public class ApplicationController {
	...
	public String createUser(@RequestHeader(value = "password", required = true) String password,
	...
	public String userLogin(@RequestHeader(value = "password", required = true) String password,
	...
	public String changePw(@RequestHeader(value = "oldPassword", required = true) String oldPassword,
			@RequestHeader(value = "newPassword", required = true) String newPassword,
			@RequestHeader(value = "userName", required = true) String userName) throws NoSuchAlgorithmException, NoSuchPaddingException, Exception {
